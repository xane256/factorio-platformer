...
aquilo_chunk.icon = "__platformer-fork__/graphics/icons/aquilo-asteroid-chunk.png"
...
for i = 1, 6, 1 do
    aquilo_chunk.graphics_set.variations[i].color_texture.filename =
        "__platformer-fork__/graphics/entity/aquilo/chunk/asteroid-aquilo-chunk-colour-0" .. i .. ".png"
end
...
aquilo_small.icon = "__platformer-fork__/graphics/icons/small-aquilo-asteroid.png"
...
for i = 1, 7, 1 do
    aquilo_small.graphics_set.variations[i].color_texture.filename =
        "__platformer-fork__/graphics/entity/aquilo/small/asteroid-aquilo-small-colour-0" .. i .. ".png"
end
...
aquilo_medium.icon = "__platformer-fork__/graphics/icons/medium-aquilo-asteroid.png"
...
for i = 1, 5, 1 do
    aquilo_medium.graphics_set.variations[i].color_texture.filename =
        "__platformer-fork__/graphics/entity/aquilo/medium/asteroid-aquilo-medium-colour-0" .. i .. ".png"
end
...
aquilo_big.icon = "__platformer-fork__/graphics/icons/big-aquilo-asteroid.png"
...
for i = 1, 5, 1 do
    aquilo_big.graphics_set.variations[i].color_texture.filename =
        "__platformer-fork__/graphics/entity/aquilo/big/asteroid-aquilo-big-colour-0" .. i .. ".png"
end
...
aquilo_huge.icon = "__platformer-fork__/graphics/icons/huge-aquilo-asteroid.png"
...
for i = 1, 7, 1 do
    aquilo_huge.graphics_set.variations[i].color_texture.filename =
        "__platformer-fork__/graphics/entity/aquilo/huge/asteroid-aquilo-huge-colour-0" .. i .. ".png"
end
