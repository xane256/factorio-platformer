...
data.raw.recipe["metallic-asteroid-crushing"].icon = "__platformer-fork__/graphics/icons/metallic-asteroid-crushing.png"
...
data.raw.recipe["advanced-metallic-asteroid-crushing"].icon = "__platformer-fork__/graphics/icons/advanced-metallic-asteroid-crushing.png"
...
data.raw.recipe["scrap-recycling"].results = {
    ...
    { type = "item", name = "solid-fuel",            amount = 1, independent_probability = 0.07, show_details_in_recipe_tooltip = false },
    ...
    { type = "item", name = "battery",               amount = 1, independent_probability = 0.04, show_details_in_recipe_tooltip = false },
    { type = "item", name = "ice",                   amount = 1, independent_probability = 0.05, show_details_in_recipe_tooltip = false },
