...
fulgora_chunk.icon = "__platformer-fork__/graphics/icons/fulgora-asteroid-crushing.png"
...
fulgora_asteroid_chunk_recycling.icon = "__platformer-fork__/graphics/icons/fulgora-asteroid-chunk.png"
